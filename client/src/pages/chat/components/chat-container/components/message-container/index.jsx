...
const MessageContainer = () => {
          ...
          <div
            className={`${
              message.sender !== selectedChatData._id
                ? "bg-[#8417ff]/40*/ text-[white]/90 border-[#8417ff]/50"
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full">
      ...
      {showImage && (
        <div className="fixed top-0 left-0 h-[100vh] w-[100vw] z-[1000] flex items-center justify-center backdrop-blur-lg flex-col">
          <div>
            <img
              src={`${HOST}/${imageURL}`}
