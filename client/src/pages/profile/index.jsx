...
const Profile = () => {
  ...
  const handleNavigate = () => {
    if (userInfo.profileSetup) {
      ...
      toast.error("Please set up a profile first");
    }
  };
  ...
  return (
    <div className="bg-[#1b1c24] h-screen flex items-center justify-center gap-10 flex-col">
      <div className="flex flex-col gap-10 w-full max-w-screen-lg md:w-auto">
        <div>
          <IoArrowBack
          ...
          >
            <Avatar className="w-full h-full rounded-full overflow-hidden">
              {image ? (
                ...
                <div
                  className={`uppercase w-full h-full text-5xl flex items-center justify-center rounded-full ${getColor(
                    selectedColor
                  )}`}
                >
